...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
  <a class="navbar-brand text-light" href="#">Soclpie</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="like.php">Likes</a>
          <a class="dropdown-item" href="follow.php">Followers</a>
          <a class="dropdown-item" href="comment.php">Comments</a>
        </div>
      </li>
      <li class="nav-item">

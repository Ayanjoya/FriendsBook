...
J:"ytp-miniplayer-ui"});this.il=!1;this.player=a;this.L(a,"minimized",this.Kh);this.L(a,"onStateChange",this.bP)},Q5=function(a){g.UN.call(this,a);
...
g.k.show=function(){this.Gc=new g.Bn(this.Kn,null,this);this.Gc.start();if(!this.il){this.tooltip=new g.AS(this.player,this);g.C(this,this.tooltip);g.GN(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.tb=new g.hP(this.player);g.C(this,this.tb);this.Wi=new g.U({D:"div",J:"ytp-miniplayer-scrim"});g.C(this,this.Wi);this.Wi.ba(this.element);this.L(this.Wi.element,"click",this.DC);var a=new g.U({D:"button",W:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Close"},K:[g.yM()]});
g.C(this,a);a.ba(this.Wi.element);this.L(a.element,"click",this.Dl);a=new O5(this.player,this);g.C(this,a);a.ba(this.Wi.element);this.oj=new g.U({D:"div",J:"ytp-miniplayer-controls"});g.C(this,this.oj);this.oj.ba(this.Wi.element);this.L(this.oj.element,"click",this.DC);var b=new g.U({D:"div",J:"ytp-miniplayer-button-container"});g.C(this,b);b.ba(this.oj.element);a=new g.U({D:"div",J:"ytp-miniplayer-play-button-container"});g.C(this,a);a.ba(this.oj.element);var c=new g.U({D:"div",J:"ytp-miniplayer-button-container"});
g.C(this,c);c.ba(this.oj.element);this.ZC=new g.aR(this.player,this,!1);g.C(this,this.ZC);this.ZC.ba(b.element);b=new g.YQ(this.player,this);g.C(this,b);b.ba(a.element);this.nextButton=new g.aR(this.player,this,!0);g.C(this,this.nextButton);this.nextButton.ba(c.element);this.hg=new g.kS(this.player,this);g.C(this,this.hg);this.hg.ba(this.Wi.element);this.jc=new g.jR(this.player,this);g.C(this,this.jc);g.GN(this.player,this.jc.element,4);this.Kq=new g.U({D:"div",J:"ytp-miniplayer-buttons"});g.C(this,
this.Kq);g.GN(this.player,this.Kq.element,4);a=new g.U({D:"button",W:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Close"},K:[g.yM()]});g.C(this,a);a.ba(this.Kq.element);this.L(a.element,"click",this.Dl);a=new g.U({D:"button",W:["ytp-miniplayer-replay-button","ytp-button"],P:{"aria-label":"Close"},K:[g.MM()]});g.C(this,a);a.ba(this.Kq.element);this.L(a.element,"click",this.aN);this.L(this.player,"presentingplayerstatechange",this.Lb);this.L(this.player,"appresize",this.Pa);this.L(this.player,
...
g.k.aN=function(){this.player.playVideo()};
g.k.DC=function(a){if(a.target===this.Wi.element||a.target===this.oj.element)g.Q(this.player.O().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.lG(g.pM(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.oa("onExpandMiniplayer")};
...
g.k.Kn=function(){this.cd();this.Gc&&this.Gc.start()};
g.k.Lb=function(a){g.T(a.state,32)&&this.tooltip.hide()};
g.k.Pa=function(){this.jc.setPosition(0,g.pN(this.player).getPlayerSize().width,!1);this.jc.ex()};
g.k.bP=function(a){this.player.app.M.o&&(0===a?this.hide():this.show())};
